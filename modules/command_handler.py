...
class Commands():
    ...
    async def roll_parabellum(self, interaction: discord.Interaction, qtd_dados: int, dificuldade: int, target: int = None):
        rolled_dice = self.utils.roll(qtd_dados, dificuldade, target)
